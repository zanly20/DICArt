...
def get_config():
    ...
    # D3PM model parameters
    parser.add_argument('--num_bins', type=int, default=360, help='Number of discretization bins for pose')
    parser.add_argument('--diffusion_steps', type=int, default=1000, help='Total diffusion steps T') 
